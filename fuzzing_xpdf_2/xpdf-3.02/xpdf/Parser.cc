...
Object *Parser::getObj(Object *obj, Guchar *fileKey,
		       ...
		       int objNum, int objGen, int recursionDepth) {
  char *key;
  Stream *str;
  Object obj2;
  int num;
...
Stream *Parser::makeStream(Object *dict, Guchar *fileKey,
			   CryptAlgorithm encAlgorithm, int keyLength,
			   int objNum, int objGen, int recursionDepth=0) {
  Object obj;
  BaseStream *baseStr;
  Stream *str;
  ...
  // get length
  dict->dictLookup("Length", &obj, recursionDepth);
  if (obj.isInt()) {
