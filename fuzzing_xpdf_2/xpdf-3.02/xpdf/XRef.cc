...
#define MAX_RECURSION_DEPTH 10	// maximum recursion depth for fetching
...
Object *XRef::fetch(int num, int gen, Object *obj, int recursionDepth=0) {
  XRefEntry *e;
  Parser *parser;
  Object obj1, obj2, obj3;

  if (recursionDepth > MAX_RECURSION_DEPTH) { return obj->initNull(); }
